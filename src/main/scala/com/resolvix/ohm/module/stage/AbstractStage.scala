...
/**
  * Provides an abstract implementation of an intermediate processing stage,
  * based on the [[api.Stage]] interface specification.
  *
  * @tparam AS the type extending the [[AbstractStage]] class for the stage
  * @tparam I the type representing the input to the stage
  * @tparam O the type representing the output from the stage
  * @tparam R the type extending the [[api.StageResult]] interface
  *   representing the results generated by the stage in response
  *   to inputs.
  */
